...
var bobLikes = [];
bobLikes.push(["apples", "bananas", "cherries"]);
var bobHair = {
	style: 'spikey',
	color: 'brown',
}
var truth = (bob === 'presidentOfTheUnitedStates')
...
var zoo = {
	monkeys: ['joe','leroy','hermiie','magnolia','parmeson','jacky','clemintine','claire'],
	giraffes:['koli','kudaa','jerome','michael'],
	elephants:['mubooo','joki']
}
...
function outside(temp,humid,cloud){
	if(temp > 80 && humid > 40) {
		...
		return "Im litterally in the desert";
	}
...
console.log(outside(90,30,10));
console.log(outside(90,50));
console.log(outside(10,10,70));
console.log(outside(90,60,60));
